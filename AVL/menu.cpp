            ...
            do
            {
                ...
                case 4:
                {
                    ...
                    do
                    {
                        ...
                        cout << "Goals scored by the player " << name<<" are:  "<<champ.getPlayerGoalsInChamp( team, name)<<endl;
...
int main()
{
    ifstream inputFile("C:\\Users\\omen3\\OneDrive\\Bureau\\code\\code\\data\\PlayersU.txt");
    ...
    ifstream File("C:\\Users\\omen3\\OneDrive\\Bureau\\code\\code\\data\\Players History.txt");
    if (!File.is_open())
    {
    ...
    Round r1(1);
    readGameData("C:\\Users\\omen3\\OneDrive\\Bureau\\code\\code\\data\\ROUND1.txt", r1);
    Round r2(2);
    readGameData("C:\\Users\\omen3\\OneDrive\\Bureau\\code\\code\\data\\ROUND2.txt", r2);
    Round r3(3);
    readGameData("C:\\Users\\omen3\\OneDrive\\Bureau\\code\\code\\data\\ROUND3.txt", r3);
