...
struct round_node
{
  round_node() : key(0), left(nullptr), right(nullptr) {} // Default constructor

  round_node(Round num) : key(Round(num)), left(nullptr), right(nullptr) {} // Parameterized constructor
...
private:
  ...
  void addRoundToTree(round_node *node, Round roundNum);
